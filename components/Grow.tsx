...
const Grow = () => {
    return (
        <div className='grow-bg w-full flex flex-col justify-center align-middle items-center relative'>
            ...
            {/* Top */}
            <div className='flex flex-col justify-center align-middle items-center py-10 px-2'>
                {/* Title */}
                ...
                {/* Body */}
                <p className='font-medium z-20 text-white text-center w-full md:w-1/3 text-lg'>
